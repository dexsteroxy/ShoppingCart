      ...
      <div className=" w-full bg-gray-100 p-4">
        {products.length > 0 ? (
          ...
          <motion.div
            ...
            className="md:flex   justify-center items-center gap-4 py-10"
          >
            <div>
              <img
                className=" hover:animate-bounce transition-all duration-300 w-80 rounded-lg p-4 mx-auto"
                src={empty}
                alt=""
              />
            </div>
            <div className=" md:w-96 p-4 bg-white flex flex-col items-center rounded-md shadow-lg">
             ...
             <button className=" mt-6 bg-amazon_light text-white  rounded-md cursor-pointer    px-8 py-2 font-poppins font-semibold text-sm">
                Continue <span className=" hidden sml:inline-flex"> Shopping</span>
              </button>
             </Link>
            </div>
          </motion.div>
