...
function Pay() {
  ...
  return (
    <div className=" bg-white">
      ...
      <p className=" text-sm md:text-base font-poppins">Once again thank you for shopping with us please share this site with your friends<br/>and also keep in touch with us to know when our new product will be available.</p>
...
<button className=" md:mt-6 bg-cyan-500  rounded-md cursor-pointer hover:bg-cyan-600  active:bg-cyan-700   px-8 py-2 font-poppins font-semibold text-sm">
   Back to Home
     ...
     <p className="text-cyan-600 md:px-3 p-3 ">See you next time {userInfo.userName}</p>
    </div>
  );
}
